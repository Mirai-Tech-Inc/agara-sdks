export interface paths {
    ...
    "/trade/v1/orders/by-hash/{order_hash}": {
        ...
        get: operations["get_order_by_hash"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/trade/v1/portfolio/pnl/history": {
        ...
        get: operations["portfolio_pnl_history"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        TradeStatus: string;
        /** @description Bounded historical timeline plus exact step-held range boundaries. */
        WalletPnlHistoryDto: {
            /** @description Step-held snapshot at the range end, absent before the first completed run. */
            end?: components["schemas"]["WalletPnlSnapshotDto"] | null;
            /**
             * Format: date-time
             * @description Requested inclusive range start.
             */
            from: string;
            /** @description Whether the range contains more completed buckets than returned. */
            has_more: boolean;
            /** @description End minus start lifetime PnL, present only with both boundaries; this is not attribution. */
            lifetime_pnl_change_micro?: string | null;
            /** @description Completed PnL buckets in the requested range. */
            points: components["schemas"]["WalletPnlSnapshotDto"][];
            /** @description Step-held snapshot at the range start, absent before the first completed run. */
            start?: components["schemas"]["WalletPnlSnapshotDto"] | null;
            /**
             * Format: date-time
             * @description Requested inclusive range end.
             */
            to: string;
        };
        /** @description One full-lifetime settled-PnL value with mark and custody provenance. */
        WalletPnlSnapshotDto: {
            /**
             * Format: date-time
             * @description Scheduled mark and PnL bucket.
             */
            bucket_at: string;
            /**
             * Format: int64
             * @description Custody chain.
             */
            chain_id: number | bigint;
            /**
             * Format: int32
             * @description Immutable custody classifier version.
             */
            classification_version: number;
            /** @description Current collateral in micro-collateral units. */
            collateral_micro: string;
            /** @description Cumulative external inflows in micro-collateral units. */
            cumulative_inflow_micro: string;
            /** @description Cumulative external outflows in micro-collateral units. */
            cumulative_outflow_micro: string;
            /**
             * Format: int64
             * @description Last custody block included.
             */
            custody_through_block: number | bigint;
            /** @description Hash of the last custody block included. */
            custody_through_block_hash: string;
            /**
             * Format: date-time
             * @description Timestamp of the last custody block included.
             */
            custody_through_block_time: string;
            /** @description Full-lifetime settled PnL in micro-collateral units. */
            lifetime_pnl_micro: string;
            /**
             * Format: date-time
             * @description When mark capture completed.
             */
            mark_captured_at: string;
            /**
             * Format: uuid
             * @description Exact completed mark run.
             */
            mark_run_id: string;
            /**
             * Format: int32
             * @description Positive custody positions included in valuation.
             */
            position_count: number;
            /** @description Marked position value in micro-collateral units. */
            positions_value_micro: string;
            /**
             * Format: int64
             * @description Wallet-universe generation included by the snapshot.
             */
            wallet_universe_generation: number | bigint;
        };
    };
    responses: never;
    parameters: never;
...
export interface operations {
    ...
    get_order_by_hash: {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description EIP-712 order hash supplied when the signed order was placed. */
                order_hash: string;
            };
            cookie?: never;
        };
        ...
        responses: {
            ...
            /** @description No order with this hash, or not yours. */
            404: {
                headers: {
                    /** @description Origin request identifier to retain when contacting support. Edge-generated 429 responses may omit it. */
                    "X-Request-ID"?: string;
    ...
    portfolio_pnl: {
        ...
        requestBody?: never;
        responses: {
            /** @description Current full-lifetime settled PnL with custody and mark provenance. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["WalletPnlSnapshotDto"];
                };
            };
            /** @description Missing or invalid access token. */
            401: {
            ...
            /** @description A complete custody or mark snapshot is not available yet. */
            425: {
                headers: {
                    /** @description Origin request identifier to retain when contacting support. Edge-generated 429 responses may omit it. */
                    "X-Request-ID"?: string;
            ...
            /** @description Settled PnL is temporarily unavailable. */
            503: {
                headers: {
                    /** @description Origin request identifier to retain when contacting support. Edge-generated 429 responses may omit it. */
                    "X-Request-ID"?: string;
    ...
    portfolio_pnl_history: {
        parameters: {
            query: {
                ...
                from: string;
                /** @description Inclusive RFC 3339 range end. */
                to: string;
                /** @description Maximum completed buckets; defaults to 672 and cannot exceed 2880. */
                limit?: number;
            };
            header?: never;
            path?: never;
        ...
        requestBody?: never;
        responses: {
            /** @description Completed lifetime-PnL buckets and step-held range boundaries. The change is not action attribution. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["WalletPnlHistoryDto"];
                };
            };
            /** @description Missing or invalid access token. */
            401: {
            ...
            /** @description The range or limit is invalid. */
            422: {
                headers: {
                    /** @description Origin request identifier to retain when contacting support. Edge-generated 429 responses may omit it. */
                    "X-Request-ID"?: string;
            ...
            /** @description No completed settled-PnL snapshot is available yet. */
            425: {
                headers: {
                    /** @description Origin request identifier to retain when contacting support. Edge-generated 429 responses may omit it. */
                    "X-Request-ID"?: string;
